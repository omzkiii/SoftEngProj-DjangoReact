const inventory = () => {
  ...
  return (
      ...
      <div className="h-auto w-auto flex-column flex-start pt-5 pb-5 border-solid 2 border-orange-500 container mx-auto">
        <div class="w-max h-5">
        <button class="bg-orange-500 text-black text-sm font-bold focus:ring-4 border-solid border border-l-orange-500 rounded-full px-5 py-1.5 text-center inline-flex items-center mr-2 dark:hover:bg-green-500 dark:hover:text-orange-500 dark:border-black">
      ...
      <div className="h-auto w-auto flex justify-space-between p-1 text-black container mx-auto">
        ...
        <div class="w-1/4 flex jutify-end font-semibold">
...
<div className="h-auto w-auto flex flex-row justify-around justify-items-center border-2 solid mt-1 border-black container mx-auto text-black">
  <table className="w-full font-sans text-xl bg-white text-black">
    ...
    <thead>
      <tr className="bg-orange-400 text-white text-4xl">
  ...
  <tr>
      <td class="px-6 py-4 border-solid border-gray-200 text-center font-bold">
      <img src="logobg.png" alt="Image Description" class="w-16 h-16 object-cover mx-auto"></img></td>
      <td class="px-6 py-4 border-solid border-gray-200 text-center">data</td>
      <td class="px-6 py-4 border-solid border-gray-200 text-center">data</td>
      <td class="px-6 py-4 border-solid border-gray-200 text-center">data</td>
...
<div className="h-auto w-auto flex flex-row text-black justify-end font-sans font-semibold container mx-auto mt-10 items-end ">
          <div class="w-1/6">VOUCHER</div>


          <div class="w-1/6">$$$</div>
      </div>
      <div className="h-auto w-auto flex flex-row justify-end  container mx-auto font-sans font-semibold items-end text-black">
