...
const inventory = () => {
    ...
    return (
        ...
        <div className="h-auto w-auto flex-column flex-start pt-5 pb-5 border-solid 2 border-orange-500 container mx-auto">
            <div class="w-max h-5">
            <button class="bg-green text-amber-400 text-sm font-bold focus:ring-4 border-solid border border-l-orange-500 rounded-full px-5 py-1.5 text-center inline-flex items-center mr-2 dark:hover:bg-green-900 dark:hover:text-orange-500 dark:border-black">
    ...
    <div className="h-auto w-auto flex flex-row justify-around justify-items-center border-2 solid mt-1 border-black container mx-auto text-black">
      <table className="w-full font-sans text-xl bg-white text-black">
        ...
        <tr>
          ...
          <td class="px-6 py-4 border-solid text-green font-semibold border-gray-200 text-center">data</td>
          <td class="px-6 py-4 border-solid text-green font-semibold border-gray-200 text-center">data</td>
          <td class="px-6 py-4 border-solid text-green font-semibold border-gray-200 text-center">data</td>
      </tr>
