        ...
        <div className="w-full flex flex-row">
          <div className="h-screen w-screen bg-green-400 font-bold flex flex-col">
            ...
            <div class=" p-8 pt-0  rounded">
              ...
              <h2 class="font-sans text-center mb-5 mt-8 text-4xl text-amber-400">Payment</h2>
              <div className="mb-4 flex justify-center mx-auto font-sans font-bold gap-12"> 
              <div className="">
                <button type="radio" id="button3" className="px-9 p-3 border border-gray-300 rounded-[10px] bg-white text-amber-400 hover:bg-amber-400 hover:text-white focus:outline-none focus:ring focus:border-blue-300">
                  GCASH
                </button>
              </div>
              <div className="">
                <button type="radio" id="button4" className="px-9 p-3 border text-s border-gray-300 rounded-[10px] bg-white text-amber-400 hover:bg-amber-400 hover:text-white focus:outline-none focus:ring focus:border-blue-300">
                  CREDIT/DEBIT CARD
                </button>
              </div>
              <div className="">
                <button type="radio" id="button5" className="px-9 p-3 border border-gray-300 rounded-[10px] bg-white text-amber-400 hover:bg-amber-400 hover:text-white focus:outline-none focus:ring focus:border-blue-300">
                  MAYA
                </button>
              </div>
              </div>
              ...
              <button type="submit" class="bg-amber-400  text-white p-2 hover:bg-white hover:text-amber-400 w-2/6  ">PLACE ORDER</button>
             </div>
             
            
              </div>
          {/* order summary */}
            <div className="w-2/5 text-green justify-center flex-col bg-white ">
            <h2 class="font-sans m-10 text-4xl font-semibold text-center text-amber-400">Order Summary</h2>
            <div className="flex flex-row mx-10 ">
              ...
              <h1 class="px-full  border-solid  border-gray-200 font-sans font-semibold text-3xl text-amber-400 ">P.500</h1>       
                </div>
            </div>
            ...
            {/* tatlo lng baka sumabog */}
                    <div className=" flex flex-row justify-center text-xl text-amber-400 font-sans font-semibold mx-10 mt-7">
                      <div class="w-1/2">SUBTOTAL</div> 
                      <div class="w-1/2">P1500.00</div>
                    </div>

                    <div className=" flex flex-row justify-center text-amber-400 font-sans font-semibold mx-10 ">
